...
write.csv(noabun_std, 'boot_phys_noabun.csv', row.names=F)
...
# Save tables
write.csv(noabun_ests, 'Phys_testdata_noabun_parameterEstimates.csv')
write.csv(total, 'Phys_testdata_noabun_totaleffects.csv', row.names=T)
write.csv(direct_rich, 'Phys_testdata_noabun_directeffects_richness.csv', row.names=T)
write.csv(indirect_reg, 'Phys_testdata_noabun_indirecteffects_via_regS.csv', row.names=T)
write.csv(indirect_for, 'Phys_testdata_noabun_indirecteffects_via_forest.csv', row.names=T)

save.image('bootstrap_phys_noabun_model.RData')
