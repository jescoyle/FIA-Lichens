...
working_data_test = subset(working_data_test, !is.na(fric))
...
write.csv(endfit_std, 'boot_fric.csv', row.names=F)
...
# Save tables
write.csv(endfit_ests, 'Fric_testdata_parameterEstimates.csv')
write.csv(total, 'Fric_testdata_totaleffects.csv', row.names=T)
write.csv(direct_rich, 'Fric_testdata_directeffects_richness.csv', row.names=T)
write.csv(direct_abun, 'Fric_testdata_directeffects_abundance.csv', row.names=T)
write.csv(indirect, 'Fric_testdata_indirecteffects_via_abundance.csv', row.names=T)
write.csv(indirect_reg, 'Fric_testdata_indirecteffects_via_regS.csv', row.names=T)
write.csv(indirect_for, 'Fric_testdata_indirecteffects_via_forest.csv', row.names=T)




save.image('bootstrap_fric_model.RData')
