...
write.csv(noabun_std, 'boot_allsp_noabun.csv', row.names=F)
...
# Save tables
write.csv(noabun_ests, 'AllSp_testdata_noabun_parameterEstimates.csv')
write.csv(total, 'AllSp_testdata_noabun_totaleffects.csv', row.names=T)
write.csv(direct_rich, 'AllSp_testdata_noabun_directeffects_richness.csv', row.names=T)
write.csv(indirect_reg, 'AllSp_testdata_noabun_indirecteffects_via_regS.csv', row.names=T)
write.csv(indirect_for, 'AllSp_testdata_noabun_indirecteffects_via_forest.csv', row.names=T)

save.image('bootstrap_allsp_noabun_model.RData')
