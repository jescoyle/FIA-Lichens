...
write.csv(noabun_std, 'boot_fric_noabun.csv', row.names=F)
...
# Save tables
write.csv(noabun_ests, 'Fric_testdata_noabun_parameterEstimates.csv')
write.csv(total, 'Fric_testdata_noabun_totaleffects.csv', row.names=T)
write.csv(direct_rich, 'Fric_testdata_noabun_directeffects_richness.csv', row.names=T)
write.csv(indirect_reg, 'Fric_testdata_noabun_indirecteffects_via_regS.csv', row.names=T)
write.csv(indirect_for, 'Fric_testdata_noabun_indirecteffects_via_forest.csv', row.names=T)

save.image('bootstrap_fric_noabun_model.RData')
