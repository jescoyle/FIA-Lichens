# This script bootstraps parameter estimates for the finalmod model fit to Physciaceae species richness.
...
path_finalmod = "
	...
	lichen_rich ~ r1fh1*bark_moist_pct.rao.ba + r1fh2*wood_SG.rao.ba + r1fh3*LogSeed.rao.ba +
		...
		r1cm1*wetness + r1cm2*rain_lowRH + r1cm3*iso + r1cm4*pseas + r1cm5*mat + r1cm6*radiation + r1R1*regPhys + r1p1*totalNS +
		r1a1*phys_abun_log
...
load('finalmod_Phys_testdata_output.RData') 
