...
path_regTorich_nopol = "
	...
	regPhys ~ R1CM1*wetness_reg_mean + R1CM2*rain_lowRH_reg_mean + R1CM3*iso_reg_mean + R1CM4*pseas_reg_mean + R1CM5*mat_reg_mean +
	...
	Phys_log ~ r1fh1*bark_moist_pct.rao.ba + r1fh2*wood_SG.rao.ba + r1fh3*LogSeed.rao.ba +
		...
		r1cm1*wetness + r1cm2*rain_lowRH + r1cm3*iso + r1cm4*pseas + r1cm5*mat + r1cm6*radiation + r1R1*regPhys +
		r1CM1*wetness_reg_mean + r1CM3*rain_lowRH_reg_mean + r1CM3*iso_reg_mean + r1CM4*pseas_reg_mean + r1CM5*mat_reg_mean +
		r1CH1*wetness_reg_var + r1CH2*rain_lowRH_reg_var + r1CH3*iso_reg_var + r1CH4*pseas_reg_var + r1CH5*mat_reg_var +
		r1FH1*regS_tree + r1a1*phys_abun_log
	
	# Effects on local lichen abundance
	phys_abun_log ~ a1fh1*bark_moist_pct.rao.ba + a1fh2*wood_SG.rao.ba + a1fh3*LogSeed.rao.ba +
...
load('regToRich_nopol_Phys_testdata_output.RData') 
...
# convert regPhys -> regS and phys_abun_log -> tot_abun_log and Phys_log -> lichen.rich_log
...
ests$rhs[grep('Phys_log', ests$rhs)] <- 'lichen.rich_log'
ests$lhs[grep('Phys_log', ests$lhs)] <- 'lichen.rich_log'
