...
nopol_recip_fit =  sem(path_nopol_recip, data=working_data_test, fixed.x=T, estimator='ML', se='robust.sem')
use_fit = nopol_recip_fit
...
nopol_recip_boot = mod_boot

# Save raw bootstrap output and models
save(nopol_recip_fit, nopol_recip_boot, path_nopol_recip, file=paste(modform,response,'testdata_output.RData', sep='_'))
