...
write.csv(noabun_std, 'boot_raoQ_noabun.csv', row.names=F)
...
# Save tables
write.csv(noabun_ests, 'RaoQ_testdata_noabun_parameterEstimates.csv')
write.csv(total, 'RaoQ_testdata_noabun_totaleffects.csv', row.names=T)
write.csv(direct_rich, 'RaoQ_testdata_noabun_directeffects_richness.csv', row.names=T)
write.csv(indirect_reg, 'RaoQ_testdata_noabun_indirecteffects_via_regS.csv', row.names=T)
write.csv(indirect_for, 'RaoQ_testdata_noabun_indirecteffects_via_forest.csv', row.names=T)

save.image('bootstrap_raoQ_noabun_model.RData')
