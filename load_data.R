...
model_data = read.csv('./Data/fia_lichen_model_data', rownames=1)
trans_data = read.csv('./Data/fia_lichen_trans_data', rownames=1)
working_data = read.csv('./Data/fia_lichen_working_data', rownames=1)
working_data_unstd = read.csv('./Data/fia_lichen_working_data_unstd', rownames=1)
