...
write.csv(endfit_std, 'boot_allsp.csv', row.names=F)
...
write.csv(total, 'AllSp_testdata_totaleffects.csv', row.names=T)
write.csv(direct_rich, 'AllSp_testdata_directeffects_richness.csv', row.names=T)
